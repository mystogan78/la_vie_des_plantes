...
var nivoslider=new NivoSlider(this,options);element.data('nivoslider',nivoslider)})};$.fn.nivoSlider.defaults={effect:'sliceUp',slices:15,boxCols:8,boxRows:4,animSpeed:500,pauseTime:3000,startSlide:0,directionNav:!0,controlNav:!1,controlNavThumbs:!1,pauseOnHover:!0,manualAdvance:!1,prevText:'Prev',nextText:'Next',randomStart:!1,beforeChange:function(){},afterChange:function(){},slideshowEnd:function(){},lastSlide:function(){},afterLoad:function(){}};$.fn._reverse=[].reverse})(jQuery);
...
jQuery(document).ready(function(){jQuery('.srchicon').click(function(){jQuery('.searchtop').toggle();jQuery('.topsocial').toggle()})});jQuery(document).ready(function(){jQuery('h2.site-title, .w-cont h2, .w-fullcont h2').each(function(index,element){var heading=jQuery(element);var word_array,last_word,first_part;word_array=heading.html().split(/\s+/);last_word=word_array.pop();first_part=word_array.join(' ');heading.html([first_part,' <span>',last_word,'</span>'].join(''))})});
