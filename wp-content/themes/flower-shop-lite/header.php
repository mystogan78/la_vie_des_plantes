...
<meta name="author" content="Ton Nom ou Site">

<link rel="profile" href="http://gmpg.org/xfn/11">
<link rel="pingback" href="<?php bloginfo( 'pingback_url' ); ?>">

<!-- Ajout de FontAwesome si nécessaire -->
...
<div class="header">
  <div class="container">
    ...
    <div class="cart-item"> 
 <a href="<?php echo wc_get_cart_url(); ?>" title="<?php esc_attr_e('Voir votre panier', 'flower-shop-lite'); ?>">
        <i class="fas fa-shopping-cart"></i> <!-- Icône seule -->
    </a>
